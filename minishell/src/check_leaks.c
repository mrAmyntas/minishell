...
static void print_allocs(FILE *fp);
...
static void print_call(t_call *call, FILE *fp) {
    fprintf(fp, "Leak at address: 0x%lx | Leaked %ld bytes\n%s\n\n",
